---
title: 'Developer Tools I use for a Minimalistic Workflow'
description: 'A list of developer tools that have optimised my workflow and productivity.'
date: 2025-07-31
tags: ['Developer Tools', 'Productivity']
image: './developer-tools.webp'
---
...
This is, without a doubt, my single most important tool. I've moved my entire life from Notion to Obsidian, and it has been a game changer. It is my 'second brain', a Markdown-based knowledge base that is incredibly fast, private, and doesn't lock me into an online service. I use it to manage my entire P.A.R.A. system; my `02_Areas` act as dashboards for DevOps and personal life, while my `01_Projects` track active work like these blog and project posts.
