---
title: 'Part 4: Production EKS Deployment'
description: "Building a production-grade Amazon EKS (Kubernetes) Cluster and deploying our application for the world to see."
date: 2025-11-05
order: 4
tags: ['Kubernetes', 'EKS', 'AWS', 'DevOps']
authors: ['tawfiq']
---
...
`eksctl` works in the background (using AWS CloudFormation) to build an entire, production-ready stack for us:
...
***Replace eu-west-2 and your-vpc-id-here with your actual region and VPC ID.***
