...
**In our next post** [Part 3](/blog/chat-app-eks/part-3), we'll take this a step further. We'll build an automated CI/CD pipeline with GitHub Actions so that every time we push new code, our `my-chat-app` image is built and pushed to a central registry (ECR) automatically.
