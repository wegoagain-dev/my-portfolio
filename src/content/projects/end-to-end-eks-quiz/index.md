---
title: Production Grade Three-Tier App on AWS EKS (EC2, RDS, ECR, ALB, IAM, Route53), GitOps (ArgoCD), Prometheus, Grafana, Github Actions
date: 2025-11-20
...
draft: false
repoURL: https://github.com/wegoagain-dev/3-tier-eks
---
...
You will need to install **eksctl, aws cli, kubectl and docker** on your local machine.
...
# replace with username,password,host.
```
