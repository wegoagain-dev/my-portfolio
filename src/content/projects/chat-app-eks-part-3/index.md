...
- **Part 3: Automated CI Pipeline (GitHub Actions & ECR)** (You are here)
...
In [Part 2](/projects/chat-app-eks-part-2), we created a perfect, robust Docker setup. Our app now runs reliably on our own laptop. But this still leaves two big problems:
...
Docker Hub is a public Docker registry, that you can also use but we will be using EKS in the next part, that is why we are hosting it on ECR.
...
This is the core of our CI pipeline. We will create a new file path in our project: `.github/workflows/ci.yml`. This YAML file is a set of instructions for GitHub Actions.
...
Lets head to [Part 4](/projects/chat-app-eks-part-4)
